...
<qgis version="2.18.7" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{43fa692e-034b-4485-9496-929e1df973b2}">
      <rule filter="&quot;building&quot; = NULL  OR  &quot;building&quot; is NOT NULL" key="{1eaeb327-75f4-43b1-b7b4-f75983441da8}" symbol="0" label="gebouwen"/>
      <rule filter="&quot;landuse&quot; in ('residential')" key="{e6cf2252-aaae-4f1b-b43a-5856148d1f7b}" symbol="1" label="wonen"/>
      <rule filter="&quot;landuse&quot; in ( 'harbour' ,  'industrial' ,   'industrial/comme'  , 'industrial;retai' , 'retail' )" key="{7e38f773-bcce-4442-b6e9-4ce60c3d2d8d}" symbol="2" label="industrie"/>
      <rule filter="&quot;landuse&quot; in (  'conservation' , 'heath'  ,'wetland' , 'wetlands' )" key="{36d4af40-cdb7-4256-bf24-0fd6db169819}" symbol="3" label="natuur"/>
      <rule filter="&quot;landuse&quot; in ( 'foret' ,  'forst' ,   'scrub' ,  'shrub' ,  'trees' ,  'wood', 'forest' ) or &quot;natural&quot; in ('wood')" key="{d4e19381-6c4f-46b8-ba5c-526d753c6dbd}" symbol="4" label="bos"/>
      <rule filter="&quot;landuse&quot; in ( 'field' , 'grass' , 'grassland' , 'greenfield' , 'land' ,  'meadow'  ,'pasture' )" key="{84c0c638-1e82-46e6-a1c2-450e9a56fe2e}" symbol="5" label="weide"/>
      <rule filter="&quot;natural&quot; in ('heath')" key="{e54d7fdc-3f32-43ba-90b3-3a880614e120}" symbol="6" label="heide"/>
      <rule filter="&quot;natural&quot; in ('scrub')" key="{5073d9f2-2bed-40ce-8215-c36ea3a3abe0}" symbol="7" label="struikgewas"/>
      <rule filter="&quot;natural&quot; in ('water') or &quot;waterway&quot; in ('riverbank') or &quot;water&quot; in ('river')" key="{072cb477-66f0-4111-9c69-9709c44059ac}" symbol="8" label="water"/>
      <rule filter="&quot;leisure&quot; in ('park')" key="{680c1f6e-901e-4b92-a320-9feb895e1992}" symbol="9" label="park"/>
      <rule filter="(&quot;leisure&quot; not in ('park') and &quot;leisure&quot;  is not null) or &quot;sport&quot; is not null" key="{5e839f43-399e-40ce-bff8-2affa97ce3ab}" symbol="10" label="sport en ontspanning"/>
      <rule description="land- en tuinbouw" filter="&quot;landuse&quot; in ('agricultural' ,  'farm' , 'farmland' , 'farmyard' , 'greenhouse' , 'greenhouse_horti' , 'greenhousefarmy' , 'horticulture' , 'stud_farm','plant_nursery') " key="{2532da5e-b192-45cf-b20c-5a57d9424f33}" symbol="11" label="landbouw"/>
      <rule filter="&quot;landuse&quot;  in ( 'brownfield' ,  'brownfield site' ,  'abandoned' ,  'rough' , 'wasteland') " key="{9a55d045-32a7-4045-8201-82861d8cf290}" symbol="12" label="braak"/>
      <rule filter="&quot;landuse&quot; in ('military')" key="{c97f10ec-1f72-4cbe-980a-5145e75d1fd7}" symbol="13" label="militair domein"/>
      <rule checkstate="0" filter="ELSE" key="{50a9bcfe-77c1-4dff-8837-4196a44cf78c}" symbol="14"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="fill" name="0">
        <layer pass="2" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="103,95,93,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="186,182,169,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="11">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="244,234,139,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="13">
        ...
        <layer pass="4" class="MarkerLine" locked="0">
          <prop k="interval" v="3"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="8">
        <layer pass="3" class="ShapeburstFill" locked="0">
          ...
          <prop k="color" v="160,171,229,255"/>
  ...
  <annotationform>../INVENTARISATIE</annotationform>
  <aliases>
  ...
  <editform>../INVENTARISATIE</editform>
  <editforminit/>
